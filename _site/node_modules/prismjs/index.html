...
<html lang="en">
  ...
  <link rel="canonical" href="http://localhost:4000/scribe/node_modules/prismjs/">
...
<!--
  ...
  <header class="post-header">
    <h1 class="post-title">Prism</h1>
  </header>

  <div class="post-content">
    <h1 id="prism"><a href="http://prismjs.com/">Prism</a></h1>
...
<p>You can learn more on http://prismjs.com/.</p>

<p>Why another syntax highlighter?: http://lea.verou.me/2012/07/introducing-prism-an-awesome-new-syntax-highlighter/#more-1841</p>

<h2 id="contribute-to-prism">Contribute to Prism!</h2>
...
<ul>
  ...
  <li>Do not edit <code class="highlighter-rouge">prism.js</code>, it’s just the version of Prism used by the Prism website and is built automatically. Limit your changes to the unminified files in the components/ folder. The minified files are also generated automatically.</li>
  <li>The build system uses <a href="https://github.com/gulpjs/gulp">gulp</a> to minify the files and build <code class="highlighter-rouge">prism.js</code>. Having gulp installed, you just need to run the command <code class="highlighter-rouge">gulp</code>.</li>
  ...
  <li>If you add a new language definition, theme or plugin, you need to add it to <code class="highlighter-rouge">components.js</code> as well, so that it becomes available to the download build page.</li>
</ul>
