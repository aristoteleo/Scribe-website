...
<html lang="en">
  ...
  <link rel="canonical" href="http://localhost:4000/scribe/node_modules/delegate/">
...
<!--
  ...
  <header class="post-header">
    <h1 class="post-title">delegate</h1>
  </header>
...
<div class="highlighter-rouge"><pre class="highlight"><code>npm install delegate --save
</code></pre>
</div>

<p>Or bower, too.</p>

<div class="highlighter-rouge"><pre class="highlight"><code>bower install delegate --save
</code></pre>
</div>
...
<h6 id="node-browserify">Node (Browserify)</h6>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">delegate</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'delegate'</span><span class="p">);</span>
</code></pre>
</div>

<h6 id="browser-standalone">Browser (Standalone)</h6>

<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"dist/delegate.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre>
</div>

<h2 id="usage">Usage</h2>

<h3 id="add-event-delegation">Add event delegation</h3>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="nx">delegate</span><span class="p">(</span><span class="nb">document</span><span class="p">.</span><span class="nx">body</span><span class="p">,</span> <span class="s1">'.btn'</span><span class="p">,</span> <span class="s1">'click'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">e</span><span class="p">.</span><span class="nx">delegateTarget</span><span class="p">);</span>
<span class="p">},</span> <span class="kc">false</span><span class="p">);</span>
</code></pre>
</div>

<h3 id="remove-event-delegation">Remove event delegation</h3>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">delegation</span> <span class="o">=</span> <span class="nx">delegate</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">,</span> <span class="s1">'click'</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">e</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">e</span><span class="p">.</span><span class="nx">delegateTarget</span><span class="p">);</span>
<span class="p">},</span> <span class="kc">false</span><span class="p">);</span>

<span class="nx">delegation</span><span class="p">.</span><span class="nx">destroy</span><span class="p">();</span>
</code></pre>
</div>
