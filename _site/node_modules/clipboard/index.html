...
<html lang="en">
  ...
  <link rel="canonical" href="http://localhost:4000/scribe/node_modules/clipboard/">
...
<!--
  ...
  <header class="post-header">
    <h1 class="post-title">clipboard.js</h1>
  </header>

  <div class="post-content">
    <h1 id="clipboardjs">clipboard.js</h1>
...
<div class="highlighter-rouge"><pre class="highlight"><code>npm install clipboard --save
</code></pre>
</div>
...
<p>First, include the script located on the <code class="highlighter-rouge">dist</code> folder or load it from <a href="https://github.com/zenorocha/clipboard.js/wiki/CDN-Providers">a third-party CDN provider</a>.</p>

<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"dist/clipboard.min.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">new</span> <span class="nx">Clipboard</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">);</span>
</code></pre>
</div>
...
<h3 id="copy-text-from-another-element">Copy text from another element</h3>

<p>A pretty common use case is to copy content from another element. You can do that by adding a <code class="highlighter-rouge">data-clipboard-target</code> attribute in your trigger element.</p>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="c">&lt;!-- Target --&gt;</span>
...
<h3 id="cut-text-from-another-element">Cut text from another element</h3>

<p>Additionally, you can define a <code class="highlighter-rouge">data-clipboard-action</code> attribute to specify if you want to either <code class="highlighter-rouge">copy</code> or <code class="highlighter-rouge">cut</code> content.</p>

<p>If you omit this attribute, <code class="highlighter-rouge">copy</code> will be used by default.</p>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="c">&lt;!-- Target --&gt;</span>
<span class="nt">&lt;textarea</span> <span class="na">id=</span><span class="s">"bar"</span><span class="nt">&gt;</span>Mussum ipsum cacilds...<span class="nt">&lt;/textarea&gt;</span>

<span class="c">&lt;!-- Trigger --&gt;</span>
<span class="nt">&lt;button</span> <span class="na">class=</span><span class="s">"btn"</span> <span class="na">data-clipboard-action=</span><span class="s">"cut"</span> <span class="na">data-clipboard-target=</span><span class="s">"#bar"</span><span class="nt">&gt;</span>
    Cut to clipboard
<span class="nt">&lt;/button&gt;</span>
</code></pre>
</div>

<p>As you may expect, the <code class="highlighter-rouge">cut</code> action only works on <code class="highlighter-rouge">&lt;input&gt;</code> or <code class="highlighter-rouge">&lt;textarea&gt;</code> elements.</p>

<h3 id="copy-text-from-attribute">Copy text from attribute</h3>

<p>Truth is, you don’t even need another element to copy its content from. You can just include a <code class="highlighter-rouge">data-clipboard-text</code> attribute in your trigger element.</p>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="c">&lt;!-- Trigger --&gt;</span>
<span class="nt">&lt;button</span> <span class="na">class=</span><span class="s">"btn"</span> <span class="na">data-clipboard-text=</span><span class="s">"Just because you can doesn't mean you should — clipboard.js"</span><span class="nt">&gt;</span>
    Copy to clipboard
<span class="nt">&lt;/button&gt;</span>
</code></pre>
</div>
...
<p>That’s why we fire custom events such as <code class="highlighter-rouge">success</code> and <code class="highlighter-rouge">error</code> for you to listen and implement your custom logic.</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">clipboard</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Clipboard</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">);</span>
...
<p>For a live demonstration, open this <a href="https://clipboardjs.com/">site</a> and just your console :)</p>
...
<p>For instance, if you want to dynamically set a <code class="highlighter-rouge">target</code>, you’ll need to return a Node.</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">new</span> <span class="nx">Clipboard</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">,</span> <span class="p">{</span>
...
<p>If you want to dynamically set a <code class="highlighter-rouge">text</code>, you’ll return a String.</p>
...
<p>For use in Bootstrap Modals or with any other library that changes the focus you’ll want to set the focused element as the <code class="highlighter-rouge">container</code> value.</p>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="k">new</span> <span class="nx">Clipboard</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">,</span> <span class="p">{</span>
    <span class="na">container</span><span class="p">:</span> <span class="nb">document</span><span class="p">.</span><span class="nx">getElementById</span><span class="p">(</span><span class="s1">'#modal'</span><span class="p">)</span>
<span class="p">});</span>
</code></pre>
</div>
...
<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">clipboard</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Clipboard</span><span class="p">(</span><span class="s1">'.btn'</span><span class="p">);</span>
<span class="nx">clipboard</span><span class="p">.</span><span class="nx">destroy</span><span class="p">();</span>
</code></pre>
</div>
...
<p>The good news is that clipboard.js gracefully degrades if you need to support older browsers. All you have to do is show a tooltip saying <code class="highlighter-rouge">Copied!</code> when <code class="highlighter-rouge">success</code> event is called and <code class="highlighter-rouge">Press Ctrl+C to copy</code> when <code class="highlighter-rouge">error</code> event is called because the text is already selected.</p>

<p>You can also check if clipboard.js is supported or not by running <code class="highlighter-rouge">Clipboard.isSupported()</code>, that way you can hide copy/cut buttons from the UI.</p>
