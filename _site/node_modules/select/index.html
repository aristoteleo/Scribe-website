...
<html lang="en">
  ...
  <link rel="canonical" href="http://localhost:4000/scribe/node_modules/select/">
...
<div class="highlighter-rouge"><pre class="highlight"><code>npm install select --save
</code></pre>
</div>

<p>Or bower, too.</p>

<div class="highlighter-rouge"><pre class="highlight"><code>bower install select --save
</code></pre>
</div>
...
<div class="language-html highlighter-rouge"><pre class="highlight"><code><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">"dist/select.js"</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre>
</div>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">input</span> <span class="o">=</span> <span class="nb">document</span><span class="p">.</span><span class="nx">querySelector</span><span class="p">(</span><span class="s1">'input'</span><span class="p">);</span>
<span class="kd">var</span> <span class="nx">result</span> <span class="o">=</span> <span class="nx">select</span><span class="p">(</span><span class="nx">input</span><span class="p">);</span>
</code></pre>
</div>

<h3 id="browserify">Browserify</h3>

<div class="language-js highlighter-rouge"><pre class="highlight"><code><span class="kd">var</span> <span class="nx">select</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">'select'</span><span class="p">);</span>
</code></pre>
</div>
